...
type FlatConfig struct {
	...
	S3Prefix              *string                           `mapstructure:"s3_bucket_prefix" cty:"s3_bucket_prefix" hcl:"s3_bucket_prefix"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"s3_bucket_prefix":              &hcldec.AttrSpec{Name: "s3_bucket_prefix", Type: cty.String, Required: false},
